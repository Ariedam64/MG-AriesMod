...
import { Atoms, myDecorShedItems, mySeedSiloItems, myToolShackItems } from "../store/atoms";
import {
  createAutoStore,
...
const seedSiloAutoStore = createAutoStore({
  logName: "seed",
...
const decorShedAutoStore = createAutoStore({
  logName: "decor",
...
const toolShackAutoStore = createAutoStore({
  logName: "tool",
